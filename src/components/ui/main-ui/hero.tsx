      ...
      <div className="relative z-10 mx-auto my-auto flex max-w-5xl flex-col items-center justify-center space-y-8 px-6 text-center">
        ...
        >
          ...
          >
            ...
            <a href="auth/login">🚀 ننجز واجباتك ومشاريعك بتميز</a>
          </HoverBorderGradient>
        </FadeContent>
        ...
        >
          <div className="space-y-6">
            <p className="max-w-3xl text-lg font-medium text-neutral-700 dark:text-neutral-300 md:text-xl leading-relaxed">
              نخبة النخبه من طلاب كلية الحاسبات و تقنية المعلومات نجتمع في هذي
              المنصه لنقدم الدعم واالمساعده لطلاب الكليه - نساعدك في حل الواجبات
              و تنفيذ المشاريع و العروض التقديميه
            </p>
          </div>
        </TextFade>
      </div>
