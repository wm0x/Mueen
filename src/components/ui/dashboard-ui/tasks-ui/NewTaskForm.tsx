...
const infoSections = [
...

  {
    ...
    content: [
      ...
      "قد يتم سؤالك من قِبل الدكتور/ه عن بعض الأجزاء وعدم معرفتك بها قد يؤثر على تقييمك.",
      "لضمان تنفيذ دقيق وسريع يُفضل تزويدنا بجميع المتطلبات بشكل واضح من البداية.",
      "هدفنا مساعدتك بشكل فعّال وأن تستفيد/ين من العمل وتحقق نتيجة مميزة بإذن الله.",
    ],
  },
];
