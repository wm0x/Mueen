		...
		return (
			<>
				...
				<Popover
					...
					modal={modalPopover}>
					<div id={triggerDescriptionId} className="sr-only" dir="rtl">
						Multi-select dropdown. Use arrow keys to navigate, Enter to select,
						and Escape to close.
					</div>
					<div id={selectedCountId} className="sr-only" aria-live="polite" dir="rtl">
												...
												return (
													<Badge
														...
														<div
															...
															className="ml-2 h-4 w-4 mb-0.5 cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50">
															<XCircle
																className={cn(
																	"h-3 w-3",
																	responsiveSettings.compactMode &&
							...
							<CommandList
								...
								{isGroupedOptions(filteredOptions) ? (
									filteredOptions.map((group) => (
										<CommandGroup key={group.heading} heading={group.heading} dir="rtl">
